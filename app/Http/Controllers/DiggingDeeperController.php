...
class DiggingDeeperController extends Controller
{
     ...
     * * Варіант колеції для modelu eloquent
    ...
    public function collections()
    {
        ...
        $filtered = $collection->filter(function ($item) {
            // Перевіряємо, чи об'єкт не пустий і чи має поле created_at
        ...
        // dd(compact('filtered')); // закоментувати рядки створення елементів вище перед перевіркою, якщо падає помилка
